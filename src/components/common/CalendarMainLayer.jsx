        ...
        <div className='col-xxl-3 col-lg-4'>
          <div className='card h-100 p-0'>
            <div className='card-body p-24'>
              <button
                type='button'
                className='btn  btn-primary-600 text-sm btn-sm px-12 py-12 w-100 radius-8 d-flex align-items-center gap-2 mb-32'
          ...
          <div className='modal-content radius-16 bg-base'>
            <div className='modal-body p-24 text-center'>
              ...
              <div className='d-flex align-items-center justify-content-center gap-3 mt-24'>
                ...
                <button
                  type='button'
                  className='w-50 btn  btn-primary-600 border border-primary-600 text-md px-24 py-12 radius-8'
                >
                  Delete
                </button>
              </div>
