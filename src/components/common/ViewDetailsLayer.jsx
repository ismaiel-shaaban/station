      ...
      <div className='col-xxl-3'>
        <div className='card h-100 p-0'>
          <div className='card-body p-24'>
            <button
              type='button'
              className='btn  btn-primary-600 text-sm btn-sm px-12 py-12 w-100 radius-8 d-flex align-items-center gap-2 mb-16'
              ...
              <form action='#'>
                <div className='d-flex align-items-center justify-content-between'>
                  ...
                  <div className='d-flex align-items-center gap-4 ms-16'>
                    ...
                    <button
                      type='submit'
                      className='btn  btn-primary-600 text-sm btn-sm px-12 py-12 w-100 radius-8 d-flex align-items-center justify-content-center gap-1 h-44-px'
                    >
                      <Icon
                        icon='ion:paper-plane-outline'
                        className='icon text-lg line-height-1'
